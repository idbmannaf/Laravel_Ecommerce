...
@section('content')
    <div class="container">
        <div class="ps-section__header text-center p-5 mb-3">
            <h3>{{$single_cat->name}}</h3>
        </div>
        <div class="ps-layout--shop">
            <div class="ps-layout__left">
                <aside class="widget widget_shop">
                    <h4 class="widget-title">{{$single_cat->name}}</h4>
                    <ul class="ps-list--categories">
                        @forelse($category_to_subcategory as $cat)
            ...
            <div class="ps-layout__right">
                <div class="ps-shopping ps-tab-root">
                    <div class="ps-shopping__header">
                        <p><strong> {{count($single_cat_products)}}</strong> Products found</p>
                    ...
                    <div class="ps-tabs">
                        <div class="ps-tab active" id="tab-1">
                            <div class="ps-shopping-product">
                                <div class="row">
                                    @forelse($single_cat_products as $product)
