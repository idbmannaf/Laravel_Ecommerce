<header class="header header--mobile" data-sticky="true">
            ...
            <ul class="navigation__extra">
                ...
                <li>
                    <div class="ps-dropdown language"><a href="#"><img src="{{ asset('front') }}/img/flag/en.png"
                                alt="">English</a>
                        <ul class="ps-dropdown-menu">
                            <li><a href="#"><img src="{{ asset('front') }}/img/flag/germany.png" alt=""> Germany</a>
                            </li>
                            <li><a href="#"><img src="{{ asset('front') }}/img/flag/fr.png" alt=""> France</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
    ...
    <div class="navigation--mobile">
        <div class="navigation__left"><a class="ps-logo" href="index.html"><img
                    src="{{ asset('front') }}/img/logo_light.png" alt=""></a>
        </div>
                        ...
                        <div class="ps-cart__items">
                            <div class="ps-product--cart-mobile">
                                <div class="ps-product__thumbnail"><a href="#"><img
                                            src="{{ asset('front') }}/{{ asset('front') }}/img/products/clothing/7.jpg"
                                            alt=""></a></div>
                            ...
                            <div class="ps-product--cart-mobile">
                                <div class="ps-product__thumbnail"><a href="#"><img
                                            src="{{ asset('front') }}/{{ asset('front') }}/img/products/clothing/5.jpg"
                                            alt=""></a></div>
                                <div class="ps-product__content"><a class="ps-product__remove" href="#"><i
