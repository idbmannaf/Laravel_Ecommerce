        ...
        <div class="ps-layout--shop">
            <div class="ps-layout__left">
                <aside class="widget widget_shop">
                    <h4 class="widget-title">{{$subcat->name}}</h4>
                    <ul class="ps-list--categories">
                        @forelse($all_subcategory as $cat)
                            <li class="menu-item-has-children {{ $cat->slug == Request::segment(2) ?"active_cat":'' }}">
                                <a href="{{url('subcategory/'.$cat->slug)}}">{{$cat->name}}</a>
                            </li>
                        @empty
            ...
            <div class="ps-layout__right">
                <div class="ps-shopping ps-tab-root">
                    <div class="ps-shopping__header">
                        <p><strong> {{count($subcat_products)}}</strong> Products found</p>
                    ...
                    <div class="ps-tabs">
                        <div class="ps-tab active" id="tab-1">
                            <div class="ps-shopping-product">
                                <div class="row">
                                    @forelse($subcat_products as $product)
