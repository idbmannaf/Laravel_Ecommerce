    ...
    <nav class="navbar navbar-expand-lg d-flex justify-content-between">
        <div class="" id="navbarNav">
            <ul class="navbar-nav" id="leftNav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url()->previous()}}"><i class="fas fa-angle-left"></i> &nbsp; Back</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/dashboard')}}">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" target="_blank" href="{{url('/')}}">Visit Store</a>
            </ul>
        </div>
        <div style="width: 80px;"  class="">
            <a class="" href="{{url('/dashboard')}}">
                <img width="60px" height="60px" class=" rounded-circle shadow" src="{{asset('uploads/admin-logo.jpg')}}" alt="">
            </a>
        </div>
