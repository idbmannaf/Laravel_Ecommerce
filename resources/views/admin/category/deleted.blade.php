                                ...
                                <table class="table table-hover">
                                    ...
                                    @forelse($categories as $key=> $category)
                                        <tr role="row" class="odd">
                                            ...
                                            <td width="18%">
                                                <a class="btn btn-secondary"  href="{{url('dashboard/category/'.$category->id.'/restore')}}"><i class="fas fa-undo-alt"></i></a>
                                                <a class="btn btn-primary" onclick="return confirm('Are you sure you want to permanent delete {{$category->name}} item?');" href="{{url('dashboard/category/'.$category->id.'/f-delete')}}"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr role="row" class="odd">
