...
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Deleted Sub Categories</h5>
                                ...
                                <table class="table table-hover">
                                    ...
                                    @forelse($subcategories as $key=> $category)
                                        <tr role="row" class="odd">
                                            ...
                                            <td width="18%">
                                                <a class="btn btn-secondary"  href="{{url('dashboard/sub-category/'.$category->id.'/restore')}}"><i class="fas fa-undo-alt"></i></a>
                                                <a class="btn btn-primary" onclick="return confirm('Are you sure you want to permanent delete {{$category->name}} item?');" href="{{url('dashboard/sub-category/'.$category->id.'/f-delete')}}"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr role="row" class="odd">
