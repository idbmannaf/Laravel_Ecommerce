        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{url('dashboard/sub-category/create')}}"  class="btn btn-primary m-b-md">Add Sub-Category</a>
                                ...
                                <table class="table table-hover">
                                    <thead class="bg-secondary">
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="zero-conf" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 212px;">Sub-Category</th>
                                    ...
                                    @forelse($subcategories as $key=> $category)
                                        <tr role="row" class="odd">
                                            ...
                                            <td width="20%">{{ $category->category->name }}</td>
                                            ...
                                            <td width="18%">
                                                <a class="btn btn-secondary" href="{{url('dashboard/sub-category/'.$category->id.'/edit')}}"><i class="fas fa-edit"></i></a>
                                                <a class="btn btn-primary"onclick="return confirm('Are you sure you want to delete {{$category->name}} item?');" href="{{url('dashboard/sub-category/'.$category->id.'/delete')}}"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @empty
                                        <tr role="row" class="odd">
